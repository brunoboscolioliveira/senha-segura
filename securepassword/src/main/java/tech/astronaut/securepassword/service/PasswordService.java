package tech.astronaut.securepassword.service;
...
public class PasswordService {
    ...
    public List<String> validatePass(String pass) {
        ...
        validateSpecialCaractere(pass, failures);
    ...
    private static void validateSpecialCaractere(String pass, List<String> failures) {
